 ...
 * jest metoda OnStop() i wątek kończy swoją pracę. Metoda Run() wywoływana jest bez opóźnienia, więc jeżeli nie jest konieczna ciągła praca, powinno się w niej możliwie często
 * oddawać procesor, np. poprzez QThread::msleep(int).
 *
